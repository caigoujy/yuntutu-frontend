...
/** getPictureById GET /api/picture/getPictureById */
export async function getPictureByIdUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getPictureByIdUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePicture_>('/api/picture/getPictureById', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** listPictureTagCategory GET /api/picture/tagAndCategory */
export async function listPictureTagCategoryUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponsePictureTagCategory_>('/api/picture/tagAndCategory', {
    method: 'GET',
    ...(options || {}),
  })
}
